...
from .views import RegistrationView, MyTokenObtainPairView, ChangePasswordView, UserView, UserViewSet, UpdateProfileView, UpdateProfilePhotoView, ObjectPermissionsView
