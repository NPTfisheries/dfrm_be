# Generated by Django 4.2.4 on 2023-08-03 22:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(default='images/profile/P7160105_fix.JPG', upload_to='images/profile/', verbose_name='Profile Picture')),
                ('user', models.OneToOneField(help_text='User name', on_delete=django.db.models.deletion.CASCADE, related_name='user_profiles', to=settings.AUTH_USER_MODEL, verbose_name='User Name')),
            ],
            options={
